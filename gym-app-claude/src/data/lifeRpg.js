...
export const companions = [
  ...
  },
  {
    ...
    trait: 'Turns sets, reps, and goals into flex energy.',
    mood: 'Hyped',
  ...
  },
  {
    ...
    trait: 'Runs hotter when you keep momentum across the week.',
    mood: 'Locked in',
  ...
  },
  {
    ...
    trait: 'Builds mass from heavy lifts and completed life goals.',
    mood: 'Solid',
...
export const dailyQuests = [
  {
    id: 'hydrate',
    title: 'Hydration Rune',
    area: 'nutrition',
    label: 'Drink 80 oz water',
    points: 20,
    reaction: 'happy',
    care: { energy: 4, satiety: 2, bond: 2 },
  },
  {
    id: 'lift',
    title: 'Iron Trial',
    area: 'gym',
    label: 'Log any 3 working sets',
    points: 45,
    reaction: 'power',
    care: { energy: -6, satiety: -3, bond: 6, spark: 4 },
  },
  {
    id: 'protein',
    title: 'Protein Offering',
    area: 'nutrition',
    label: 'Log a protein-rich meal',
    points: 30,
    reaction: 'happy',
    care: { satiety: 10, bond: 4 },
  },
  {
    id: 'focus',
    title: 'Focus Sigil',
    area: 'focus',
    label: 'Finish one deep-work block',
    points: 25,
    reaction: 'celebrate',
    care: { bond: 3, spark: 5 },
  },
...
export const recommendedWorkouts = [
  {
    ...
    focus: 'Full body',
    details: 'Squat 3x5, row 3x10, push-up 3xAMRAP',
    points: 65,
  },
  {
    id: 'upper-body',
    name: 'Upper Body',
    focus: 'Push and pull',
    details: 'Bench 4x6, cable row 4x10, shoulder press 3x8',
    points: 70,
  },
  {
    id: 'lower-body',
    name: 'Lower Body',
    focus: 'Legs and core',
    details: 'Deadlift 3x5, split squat 3x8, plank 3x45 sec',
    points: 75,
  },
  {
    ...
    focus: 'Engine',
    details: 'Bike 10 min, carries 4 rounds, dead bug 3x12',
    points: 55,
  },
]

export const foodShortcuts = [
  'chicken bowl',
  'salmon rice',
  'greek yogurt',
  'protein shake',
...
export const skillTrees = [
  {
    id: 'gym',
    name: 'Gym',
    perk: 'Unlock heavier quest bonuses',
    color: '#ff7a45',
    milestones: [120, 320, 640],
  },
  {
    id: 'nutrition',
    name: 'Nutrition',
    perk: 'Improve companion recovery',
    color: '#34d399',
    milestones: [100, 280, 580],
  },
  {
    id: 'focus',
    name: 'Focus',
    perk: 'Reduce missed-day penalties',
    color: '#60a5fa',
    milestones: [90, 240, 520],
  },
  {
    id: 'life',
    name: 'Life',
    perk: 'Turn personal goals into character growth',
    color: '#facc15',
...
export const achievementRules = [
  {
    id: 'first-bond',
    title: 'First Bond',
    detail: 'Choose a companion',
    test: (profile) => Boolean(profile.petType),
  },
  {
    id: 'drake-shift',
    title: 'Second Form',
    detail: 'Reach 500 total points',
    test: (profile) => profile.points >= 500,
  },
  {
    id: 'armor-up',
    title: 'Armor Up',
    detail: 'Reach 1,500 total points',
    test: (profile) => profile.points >= 1500,
  },
  {
    id: 'final-form',
    title: 'Final Form',
    detail: 'Reach 3,500 total points',
    test: (profile) => profile.points >= 3500,
  },
  {
    id: 'goal-crusher',
    title: 'Goal Crusher',
    detail: 'Complete a life goal',
  ...
  },
  {
    ...
    test: (profile) => profile.customWorkouts.length > 0,
  },
]
...
export function getNextEvolution(points) {
  ...
  if (stageIndex === evolutionThresholds.length - 1) {
    return { target: points, progress: 100, remaining: 0, label: 'Final form unlocked' }
  }
  ...
  return {
    target,
    progress: clampMeter(progress),
    remaining,
    label: `${remaining} pts to evolve`,
  }
}

export function mergeProfile(savedProfile) {
  const nextPetType = companions.some((pet) => pet.id === savedProfile?.petType)
    ? savedProfile.petType
    : defaultProfile.petType
  ...
  return {
    ...
    customWorkouts: Array.isArray(savedProfile?.customWorkouts)
    ...
    petPosition: {
      x: clampPercent(savedProfile?.petPosition?.x ?? defaultProfile.petPosition.x),
      y: clampPercent(savedProfile?.petPosition?.y ?? defaultProfile.petPosition.y),
    },
    ledger: Array.isArray(savedProfile?.ledger)
      ? savedProfile.ledger
      : defaultProfile.ledger,
    weeklyPoints: Array.isArray(savedProfile?.weeklyPoints)
      ? savedProfile.weeklyPoints
      : defaultProfile.weeklyPoints,
  }
}
